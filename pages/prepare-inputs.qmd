...
A raw survey dataset becomes cleaned microdata input ready for small area estimation through a clear estimand, a coded indicator, a target domain, a domain size, and a compatible survey weight. 

![Preparation pipeline for analysis-ready inputs](../assets/dataprep_summary.png)

:::{.callout-note}
**Covariates selection and preparation** from auxiliary datasets will be covered in subsequent chapters on model-based area-level estimation.
:::
